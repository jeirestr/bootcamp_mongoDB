...
import { getDocumentSchema } from "./getDocumentSchemaTool";
import { searchDocuments } from "./searchDocumentsTool";
...
export const allTools: AgentTool[] = [knowledgeBaseSearch, structuredQuery, assess, getDocumentSchema, searchDocuments];
